...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-1-1} 

}

\caption{(ref:fig8-1)}(\#fig:Figure8-1)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-2-1} 

}

\caption{(ref:fig8-2)}(\#fig:Figure8-2)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-3-1} 

}

\caption{(ref:fig8-3)}(\#fig:Figure8-3)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-4-1} 

}

\caption{(ref:fig8-4)}(\#fig:Figure8-4)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-5-1} 

}

\caption{(ref:fig8-5)}(\#fig:Figure8-5)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-6-1} 

}

\caption{(ref:fig8-6)}(\#fig:Figure8-6)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-7-1} 

}

\caption{(ref:fig8-7)}(\#fig:Figure8-7)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-8-1} 

}

\caption{(ref:fig8-8)}(\#fig:Figure8-8)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-9-1} 

}

\caption{(ref:fig8-9)}(\#fig:Figure8-9)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-10-1} 

}

\caption{(ref:fig8-10)}(\#fig:Figure8-10)
\end{figure}

\indent As a final assessment of this model, we can consider simulating a set of
...
{\centering \includegraphics[width=1\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-11-1} 

}

\caption{(ref:fig8-11)}(\#fig:Figure8-11)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-12-1} 

}

\caption{(ref:fig8-12)}(\#fig:Figure8-12)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-13-1} 

}

\caption{(ref:fig8-13)}(\#fig:Figure8-13)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-14-1} 

}

\caption{(ref:fig8-14)}(\#fig:Figure8-14)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-15-1} 

}

\caption{(ref:fig8-15)}(\#fig:Figure8-15)
\end{figure}
...
* **Be cautious about doing prediction in MLR -- you might be doing extrapolation!**
    ...
    {\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-16-1} 
    
    }
    
    \caption{Scatterplot of observed Elevations and Maximum Temperatures for SNOTEL data.}(\#fig:Figure8-16)
    \end{figure}
...
* **Multicollinearity in MLR models:**
    ...
    {\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-17-1} 
    
    }
    
    \caption{Plot of correlation matrix in the snow depth data set with influential points removed}(\#fig:Figure8-17)
    \end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-18-1} 

}

\caption{(ref:fig8-18)}(\#fig:Figure8-18)
\end{figure}
...
(ref:fig8-19) Diagnostic plots for the $\text{fygpa}\sim\text{satm} + \text{satm}$ model.
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-19-1} 

}

\caption{(ref:fig8-19)}(\#fig:Figure8-19)
\end{figure}
...
2. Plot the data and assess validity conditions:
    ...
    * **Linearity of relationships:**
        ...
        * The partial residuals are displayed in Figure \@ref(fig:Figure8-20)
        and do not suggest any clear missed curvature.
    ...
    * **Normality of residuals:**
        ...
        * There is a minor deviation in the upper tail of the residual
        ...
        upper limit. This is an example of a potentially ***censored***
        variable. \index{censoring} For a continuous variable it is possible
...
3. Calculate the test statistics and p-values:
    ...
    * For *satv*: $t = \dfrac{0.02539}{0.002859} = 8.88$ with the $t$ having
    $df = 997$ and p-value $<0.0001$.
    
    * For *satm*: $t = \dfrac{0.02240}{0.002786} = 8.04$ with the $t$ having
    $df = 997$ and p-value $<0.0001$.
...
5. Size:
    ...
    * The model seems to be valid and have predictors with small p-values, but
    note how much of the variation is not explained by the model. It only
    explains 21.22% \index{R-squared} of the variation in the responses. So we
    ...
    * So for a 1 percent increase in the *satv* percentile, we estimate, on
    ...
    percentile. Similarly, for a 1 percent increase in the *satm* percentile, we
    estimate, on average, a 0.0224 point change in *GPA*, after controlling for
    *satv* percentile. While this is a correct interpretation of the slope
    ...
    * The term-plots (Figure \@ref(fig:Figure8-20)) provide a visualization of
    the "size" of the differences in the response variable explained by each
    predictor. \index{effects plot} The *satv* term-plot shows that for the
    range of percentiles from around the 30^th^ percentile to the 70^th^
    percentile, the mean first year *GPA* is predicted to go from approximately
    ...
    SAT percentiles. Similarly, the *satm* term-plot shows that the *satm*
    percentiles were observed to range between around the 30^th^ percentile and
    70^th^ percentile and predict mean GPAs between 1.95 and 2.8. It seems that
    ...
    in the responses. \index{R packages!\textbf{effects}}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-20-1} 

}

\caption{(ref:fig8-20)}(\#fig:Figure8-20)
\end{figure}
...
6. Scope of Inference:
    ...
    * The term-plots also inform the types of students attending this university
...
(ref:fig8-21) Term-plots for the $\text{fygpa}\sim\text{satv} + \text{satm}$ model with 95% confidence intervals (dark, dashed lines) and 95% PIs (light grey, dotted lines). 
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-21-1} 

}

\caption{(ref:fig8-21)}(\#fig:Figure8-21)
\end{figure}
...
(ref:fig8-22) Plot of fygpa vs satv by gender of students.

\begin{figure}[ht!]

{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-22-1} 

}

\caption{(ref:fig8-22)}(\#fig:Figure8-22)
\end{figure}

(ref:fig8-23) Plot of fygpa vs satm by gender of students.

\begin{figure}[ht!]

{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-23-1} 

}

\caption{(ref:fig8-23)}(\#fig:Figure8-23)
\end{figure}
...
* Simplified model for *Males* (plug in a 0 for $I_{\text{Female},i}$):
    ...
    * $\widehat{\text{fygpa}}_i = 0.216 + 0.0386\cdot\text{satm}_i +
    0.313 \cdot 0 = 0.216 + 0.0386\cdot\text{satm}_i$
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-24-1} 

}

\caption{(ref:fig8-24)}(\#fig:Figure8-24)
\end{figure}
...
categorical variable. \index{indicator} \index{baseline}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-25-1} 

}

\caption{(ref:fig8-25)}(\#fig:Figure8-25)
\end{figure}

\indent The model summary and confidence intervals provide some potential
...
variables is "different" using the indicator coding idea. \index{indicator} For
...
$t = 7.184$ and, based on a $t_{997}$-distribution if the null is true, the
p-value is $<0.0001$. We have very strong evidence against the null hypothesis
that there is no difference in the true $y$-intercept in a *satm* model for
first year college GPA between *males* and *females*, so we would conclude that
there is a difference in their true mean GPA levels controlled for *satm*. The
...
[@R-heplots]. \index{R packages!\textbf{heplots}} Each subject was initially
...
relationship? We can use our indicator \index{indicator} approach to see if the
treatments provide a shift to higher tolerances after accounting for the
relationship between the two measurements^[Models like this with a categorical
variable and quantitative variable are often called *ANCOVA* or *analysis of
covariance* models but really are just versions of our linear models we've been
using throughout this material.]. The scatterplot^[The
``scale_color_viridis_d(end = 0.85, option = "inferno")`` code makes the plot
in a suite of four colors from the ``viridis`` package [@R-viridis] that attempt
to be color-blind friendly.] \index{R packages!\textbf{viridis}} of the results
in Figure \@ref(fig:Figure8-26) shows some variation in the slopes and the
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-26-1} 

}

\caption{(ref:fig8-26)}(\#fig:Figure8-26)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-27-1} 

}

\caption{(ref:fig8-27)}(\#fig:Figure8-27)
\end{figure}

\indent The right panel of the term-plot (Figure \@ref(fig:Figure8-28)) shows
...
second tolerance measurement. The ***R***^2^ shows that this is a decent model
...
between the grouping variable and the responses. \index{assumptions}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-28-1} 

}

\caption{(ref:fig8-28)}(\#fig:Figure8-28)
\end{figure}
...
since all the Cook's D values are less than 0.5. \index{influential}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-29-1} 

}

\caption{(ref:fig8-29)}(\#fig:Figure8-29)
\end{figure}


\indent Additionally, sometimes we need to add group information to diagnostics
...
by the ``treatment`` applied to each subject. \index{faceting}
\index{\texttt{facet\_grid}} This can be helpful with multiple groups to be able
...
(ref:fig8-30) Faceted scatterplot of residuals versus fitted values by treatment group from the additive decibel tolerance model.
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-30-1} 

}

\caption{(ref:fig8-30)}(\#fig:Figure8-30)
\end{figure}
...
\indent While there are inferences available in the model output, the tests for
the indicator variables are not too informative (at least to start) since they
only compare each group to the baseline. In Section \@ref(section8-12), we see
how to use ANOVA *F*-tests to help us ask general questions about including a
categorical predictor in the model. But we can compare adjusted ***R***^2^
values with and without *Treatment* to see if including the categorical
variable was "worth it":
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-31-1} 

}

\caption{(ref:fig8-31)}(\#fig:Figure8-31)
\end{figure}
...
\index{interaction!MLR} The formula notation is ``y ~ x * group``, remembering
...
discussed in the Two-Way ANOVA interaction model. \index{main effects} We can
...
($x$-axis in Residuals vs Fitted and Scale-Location plots) and that is not a
problem -- it is a feature of these models. \index{Residuals vs Fitted plot}
\index{Scale-Location plot} \index{assumptions} You should look for issues in
...
issues in Figure \@ref(fig:Figure8-32) because of the group differences, 
...
any influential points because no points have Cook's D over 0.5. \index{censored}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-32-1} 

}

\caption{(ref:fig8-32)}(\#fig:Figure8-32)
\end{figure}

\indent For these models, we have relaxed an earlier assumption that data were
...
\index{Residuals vs Fitted plot!by group} Figure \@ref(fig:Figure8-33)
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-33-1} 

}

\caption{(ref:fig8-33)}(\#fig:Figure8-33)
\end{figure}
...
\index{interaction!MLR} For the original research question of whether the
...
more pronounced difference in the slopes for the two groups. 


\indent In the presence of a categorical by quantitative interaction, term-plots
...
\index{interaction!MLR!term-plot} The term-plots basically provide a plot of the
"simplified" SLR models for each group. In Figure \@ref(fig:Figure8-34) we can
...
complicated of a model^[There is a way to test for a difference in the two lines
at a particular $x$ value but it is beyond the scope of this material.].
Figure \@ref(fig:Figure8-35) splits the plots up and adds partial residuals to
...
relationships between the two variables in the two groups.
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-34-1} 

}

\caption{(ref:fig8-34)}(\#fig:Figure8-34)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-35-1} 

}

\caption{(ref:fig8-35)}(\#fig:Figure8-35)
\end{figure}

\indent It certainly appears in the plots that IQ has a different impact on the
...
(Figure \@ref(fig:Figure8-36)) suggest the potentially dangerous conclusion that
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-36-1} 

}

\caption{(ref:fig8-36)}(\#fig:Figure8-36)
\end{figure}

This model provides little evidence against the null hypothesis that IQ is not
linearly related to reading score for all students ($t_{41} = 1.34$,
p-value = 0.188), adjusted for dyslexia status, but strong evidence against the
null hypothesis of no difference in the true $y$-intercepts ($t_{41} = -6.88$,
p-value $<0.00001$) after adjusting for the verbal IQ score. 
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-37-1} 

}

\caption{(ref:fig8-37)}(\#fig:Figure8-37)
\end{figure}

These results, including the term-plot in Figure \@ref(fig:Figure8-37), suggest
...
interaction is not important *in this data set*. In general, if the interaction
...
\index{interaction model} \index{additive model} Either or both of those
...
possible if large p-values are continually encountered^[This is an example of
...
deal with modifying the intercept and slope coefficients for **every**
deviation group so the task is onerous but relatively repetitive.
\index{indicator} The general model is:
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-38-1} 

}

\caption{(ref:fig8-38)}(\#fig:Figure8-38)
\end{figure}
...
additive model without missing anything interesting. \index{additive model}
There are two different options for displaying interaction models. Version 1
(Figure \@ref(fig:Figure8-38)) has a different panel for each level of the
categorical variable and Version 2 (Figure \@ref(fig:Figure8-39)) puts all the
...
(ref:fig8-39) Term-plot for decibel tolerance interaction model (version 2). This plot is not printed in color because it is impossible to distinguish the four groups whether in color or black and white, although the ``lty = c(1:4)`` that provides four different line types does help a bit.

\begin{figure}[ht!]

{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-39-1} 

}

\caption{(ref:fig8-39)}(\#fig:Figure8-39)
\end{figure}
...
\indent In situations with more than 2 levels, the $t$-tests for the interaction
or changing $y$-intercepts are not informative for deciding if you really need
different slopes or intercepts for all the groups. \index{interaction!MLR}
...
need to develop $F$-tests for the interaction part of the model. 
...
adjusted ***R***^2^ that focus on balancing model fit and complexity but
...
interaction models. \index{interaction model} \index{additive model}
We start with a discussion of the tests in an interaction setting since that
provides us the **first test to consider** in most situations to assess
...
predictor -- either is a reasonable next step. \index{non-parallel lines}
Basically this establishes a set of ***nested models*** (each model is a reduced
...
Figure \@ref(fig:Figure8-40). This is based on the assumption that we would
proceed through the model, dropping terms if the p-values are large ("not
significant" in the diagram) to arrive at a final model. \index{model!nested}

(ref:fig8-40) Diagram of models to consider in an interaction model. "Sig." means a small p-value for that term and "not sig." means a large one -- with apologies for using the "s"-word here.

\begin{figure}[ht!]

{\centering \includegraphics[width=0.75\linewidth]{chapter8_files/nestedModelTree_medium} 

}

\caption{(ref:fig8-40)}(\#fig:Figure8-40)
\end{figure}

\indent If the initial interaction test suggests the interaction is important,
...
other place where we considered interactions). \index{interaction model} If the
interaction is not deemed important based on the test, then the model should be
re-fit using both variables in an additive model. \index{additive model} In that
...
(quantitative response and $J$ group categorical explanatory) and if the only
...
package to an interaction model^[We could also use the ``anova`` function to do
this but using ``Anova`` throughout this material provides the answers we want
in the additive model and it has no impact for the only test of interest in the
interaction model since the interaction is the last component in the model.]. 
\index{\texttt{Anova()}} It will provide three tests, one for each variable by
...
\indent With the $J = 4$ level categorical variable (*Treatment*), the model for
the second noise tolerance measurement (*du2*) as a function of the interaction 
...
$F(J-1, n-J-1)$-distribution under the null hypothesis. \index{additive model}
\index{@$F$-test} For this example, the test statistic for *Treatment* follows
an $F(3, 93)$-distribution under the null hypothesis. The observed test
...
difference in $y$-intercepts between the *treatment* groups, in a model
with *du1*, in the population. We could interpret this in the fashion we used
initially in MLR by stating this result as: there is little evidence against the
null hypothesis of no difference in the mean *du2* for the *Treatment* groups
after controlling for *du1* so we would conclude that there is possibly no 
difference between the groups controlled for *du1*.
...
\indent In the same ANOVA table, there is a test for the *du1* model component.
This tests $H_0: \beta_1 = 0$ vs $H_A: \beta_1\ne 0$ in a model with different
$y$-intercepts for the different treatment groups. If we remove this term from
the model, all we are left with is different $y$-intercepts for the groups. A
model just with different $y$-intercepts is typically called a One-Way ANOVA
model. Here, there it appears that the quantitative variable is needed in the
model after controlling for the different $y$-intercepts for different
treatments since it has a small p-value ($F$(1,93) = 261.55 or $t$(93) = 16.172,
...
a time) or comparisons of adjusted ***R***^2^ across different potential models
...
interpretable scale, and, often, better performance in picking an optimal^[In
...
set of models. No such similar theory exists for the adjusted ***R***^2^.]
model than the ***adjusted*** ***R***^2^. The measure is called the ***AIC***
(Akaike's An Information Criterion^[Most people now call this Akaike's
(pronounced **ah-kah-ee-kay**) Information Criterion, but he used the
...
true model, on a log-scale**, based on a measure called the Kullback-Leibler
...
numbers -- just pick the model with the smallest AIC score. 
...
Scientists are driven to different degrees by what is called the ***principle
of parsimony***: that **simpler explanations (models) are better if everything
else is equal or even close to equal**. In this case, it would
...
*model degrees of freedom* for AIC calculations and relates to how many total
parameters are estimated. \index{degrees of freedom!model} Note that it is a 
different measure of *degrees of freedom* than used in ANOVA $F$-tests. The main
things to understand about the formula for the AIC is that as $m$ increases, the
AIC will go up and that as the fit improves, the *likelihood* will increase (so
-2*log-likelihood* will get smaller)^[More details on these components of the
methods will be left for more advanced material -- we will focus on an
introduction to using the AIC measure here.]. 
...
\indent To help with interpreting the scale of AICs, they are often reported in
a table sorted from smallest to largest values with the AIC and the "delta AIC"
or, simply, $\Delta\text{AIC}$ reported. The 
...
difference in the models and more than 4 units $(\Delta\text{AIC}>4)$ is strong
...
AICs, and $\Delta\text{AICs}$. 
    ...
    * Remember to incorporate the mean-only model in the model selection results.
...
valid in that situation). \index{assumptions}
...
package [@R-MuMIn]. \index{R packages!\textbf{MuMIn}} The name (dredge) actually
...
components. \index{hypothesis testing} Methods that consider all possible models
...
to work^[It makes it impossible to fit models with any missing values in the data
...
Table \@ref(tab:Table8-1). In that situation we were considering a "full" model 
that included *Elevation*, *Min.Temp*, and *Max.Temp* as potential predictor 
variables after removing two influential points. \index{influential} 
\index{Cook's Distance} And we considered all possible reduced models from that 
"full"^[We put quotes on "full" or sometimes call it the "fullish" model because
...
\indent In reading ``dredge`` output^[The options in ``extra = ...`` are to get
extra information displayed that you do not necessarily need. You can simply run
``dredge(m6, rank = "AIC")`` to get just the AIC results.] as it is constructed
...
ranked model from adjusted ***R***^2^, which is reproduced in the ``adjRsq``
...
\indent You can use the table of results from ``dredge`` to find information to
...
models considered, as shown in Figure \@ref(fig:Figure8-41).
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-41-1} 

}

\caption{(ref:fig8-41)}(\#fig:Figure8-41)
\end{figure}
...
using the output. It is interesting that the *Elevation* and *Max.Temp* slopes
change little with the inclusion of *Min.Temp* in moving from the top to second
ranked model (0.02408 to 0.0286 and 1.253 to 1.243). 
...
``coneproj`` package (@R-coneproj, @Liao2014). \index{R packages!\textbf{coneproj}}
...
Figure \@ref(fig:Figure8-42) shows the suggestion of different slopes for the
...
(ref:fig8-42) Scatterplot of log(FEV) vs Age by smoking status, with both combined (top) and faceted (bottom) versions.

\begin{figure}[ht!]

{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-42-1} 

}

\caption{(ref:fig8-42)}(\#fig:Figure8-42)
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-43-1} 

}

\caption{(ref:fig8-43)}(\#fig:Figure8-43)
\end{figure}

The diagnostic plots suggest that there are a few outlying points 
(Figure \@ref(fig:Figure8-43)) but they are not influential and there is no
...
make sure that the results do not look noticeably worse than these do. 

(ref:fig8-44) Term-plots for the log(FEV) model that includes height, sex, and an interaction between age and smoking status (the full model), with partial residuals. 
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-44-1} 

}

\caption{(ref:fig8-44)}(\#fig:Figure8-44)
\end{figure}

\indent Figure \@ref(fig:Figure8-44) provides our first term-plot with multiple
...
hypothesis tests here).

\indent The ``AIC`` function can be used to generate the AIC values for a 
single or set \index{\texttt{AIC()}} of candidate models. It will also provide
...
*age*, *height*, and *sex*. It has a $\Delta\text{AIC}$ of 2.87 so we would say
...
(ref:fig8-45) Display of AIC results on a number line with models indicated by their number in the ``dredge`` output. In more complex models, the ``dredge`` model numbers are just labels and not a meaningful numeration of the models being considered (there are 20 models considered here but labels go up to 32). Panel (a) presents results for all the models and panel (b) focuses just on the top 10 models so some differences in those models can be explored. Note that the spacing of the vertical grid lines in panel (a) are 10 AIC units and in (b) they are 1 AIC unit apart.

\begin{figure}[ht!]

{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-45-1} 

}

\caption{(ref:fig8-45)}(\#fig:Figure8-45)
\end{figure}


\indent The dredge results also provides the opportunity to compare the model
selection results from the adjusted ***R***^2^ compared to the AIC. The AIC
favors the model without an interaction between *age* and *smoking* whereas the
adjusted *R*^2^ favors the most complicated model considered here
...
components. \index{p-value!caution} Some of this could be confusion caused when
...
to mention that you should not use **every** method we taught you in **every**
...
selected using measures like the AIC or adjusted *R*^2^. But you can discuss the
estimated model components to go with how you arrived at having them in the model. 
...
term-plots (Figure \@ref(fig:Figure8-46)) we see that in this model there are
positive slopes for *Age* and *Height* on *log-FEV*, a negative coefficient for
*smoking* (*Smoker*), and a positive coefficient for *sex* (*Males*). There is
some multicollinearity impacting the estimates for *height* and *age* based on
having VIFs near 3 but these are not extreme issues. We could go further with
interpretations such as for the *age* term: For a 1 year increase in *age*, we
estimate, on average, a 0.0234 log-liter increase in *FEV*, after controlling
for the *height*, *smoking status*, and *sex* of the children. We can even
interpret this on the original scale since this was a *log(y)* response model
using the same techniques as in Section \@ref(section7-6). If we exponentiate
the slope coefficient of the quantitative variable, $\exp(0.0234) = 1.0237$. This
provides the interpretation on the original *FEV* scale, for a 1 year increase
in *age*, we estimate a 2.4% increase in the median *FEV*, after controlling for
the *height*, *smoking status*, and *sex* of the children. **The only difference
from Section** \@ref(section7-6) **when working with a log(y) model now is that
we have to note that the model used to generate the slope coefficient had other
components and so this estimate is after adjusting for them.** 

(ref:fig8-46) Term-plots for the top AIC model for log(FEV) that includes height, age, smoking status, and sex in the model.
...
{\centering \includegraphics[width=0.75\linewidth]{08-multipleLinearRegression_files/figure-latex/Figure8-46-1} 

}

\caption{(ref:fig8-46)}(\#fig:Figure8-46)
\end{figure}
...
coefficients and/or term-plots, and *R*^2^. This provides a useful summary of
...
The *R*^2^ is not used to select the model, but after selection can be a nice
...
\indent The AICs are a preferred modeling strategy in some fields such as
...
\index{indicator} All this power comes with some responsibility in that you need
...
Chapter \@ref(chapter9), case studies are used to review the different methods
...
geom_smooth(method = "lm")**
    ...
    * Add **color = \textcolor{red}{groupfactor}** to aesthetic to color
    points and lines based on a grouping variable. 
    
    * Add **+ facet_grid(cols = vars(\textcolor{red}{groupfactor}))** to
    facet by groups. \index{\texttt{facet\_grid()}|textbf}
...
* **\textcolor{red}{MODELNAME} ``<-`` lm(\textcolor{red}{y} ~ 
\textcolor{red}{x1 * groupfactor}, data = \textcolor{red}{DATASETNAME})**
...
8.1. **Treadmill data analysis** The original research goal for the treadmill
