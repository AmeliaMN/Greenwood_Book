...
\caption{(ref:fig2-5)}(\#fig:Figure2-5-2)
\end{figure}
...
\caption{(ref:fig2-16)}(\#fig:Figure2-16-1)
\end{figure}
\begin{figure}[ht!]

{\centering \includegraphics[width=0.75\linewidth]{02-reintroductionToStatistics_files/figure-latex/Figure2-16-2} 

}

\caption{(ref:fig2-16)}(\#fig:Figure2-16-2)
\end{figure}
...
* **histogram(**~ \textcolor{red}{VARIABLENAME}, data = \textcolor{red}{DATASETNAME}**)**

    * Makes a histogram of a variable named ``Y`` from the data set of 
    interest. 
    
* **bwplot(\textcolor{red}{Y} ~ \textcolor{red}{X}, data = \textcolor{red}{DATASETNAME})**
