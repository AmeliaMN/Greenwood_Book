...
* **favstats(**~ `r colFmt("DATASETNAME","red")`, data = `r colFmt("VARIABLENAME","red")`**)** 
...
* **histogram(**~ `r colFmt("DATASETNAME","red")`, data = `r colFmt("VARIABLENAME","red")`**)**

    * Makes a histogram. \index{\texttt{histogram()}|textbf}
    
* **bwplot(**~ `r colFmt("DATASETNAME","red")`, data = `r colFmt("VARIABLENAME","red")`**)**
