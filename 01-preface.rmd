...
knitr::include_graphics('chapter1_files/decisiontree.jpg')
```
...
knitr::include_graphics('chapter1_files/Fig1-6.png')
```
...
```{r Figure1-7, fig.cap="(ref:fig1-7)",echo=F}
histogram(~RunTime, data = treadmill, type = "count")
```
...
```{r Figure1-8, fig.cap="(ref:fig1-8)",echo=F}
old.par <- par(mai = c(0.5,0.5,0.5,0.5))
...
```{r Figure1-9, fig.cap="(ref:fig1-9)",echo=F}
...
```{r Figure1-10, fig.cap="(ref:fig1-10)",echo=F, warning=T}
library(ggplot2)
...
```{r Figure1-11, fig.cap="(ref:fig1-11)",echo=F}
ggplot(data = treadmill, mapping = aes(x = RunTime)) + 
...
```{r Figure1-12, fig.cap="(ref:fig1-12)",echo=F}
ggplot(data = treadmill, mapping = aes(x = RunTime)) + 
...
* **mean(**~ `r colFmt("VARIABLENAME","red")`, data = `r colFmt("DATASETNAME" ,"red")`**)**
    
    * Calculates the mean of the observations in a variable. 
    \index{\texttt{mean()}|textbf}

* **sd(**~ `r colFmt("VARIABLENAME","red")`, data = `r colFmt("DATASETNAME" ,"red")`**)**

    * Calculates the standard deviation of the observations in a variable. 
    \index{\texttt{sd()}|textbf}

* **favstats(**~ `r colFmt("VARIABLENAME","red")`, data = `r colFmt("DATASETNAME" ,"red")`**)** 
...
* **bwplot(**~ `r colFmt("VARIABLENAME","red")`, data = `r colFmt("DATASETNAME" ,"red")`**)**

    * Makes a boxplot. \index{\texttt{bwplot()}|textbf}

* **ggplot(data = **`r colFmt("DATASETNAME","red")`**, mapping = aes(**`r colFmt("VARIABLENAME","red")`**)) +  
geom_histogram(bins = **`r colFmt("10","red")`**)**
