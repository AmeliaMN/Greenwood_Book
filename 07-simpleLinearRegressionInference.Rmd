...
abline(coefficients(lm(meanmax ~ Year,data = bozemantemps)),lwd = 2,col = "steelblue")

plot(meanmaxC ~ Year2,data = bozemantemps,xlab = "Years since 1901",
     ylab = "degrees C",main = "degrees C and Years since 1901")
abline(coefficients(temp3),lwd = 2,col = "steelblue")
```
...
abline(coefficients(ID1),lwd = 2,col = "slateblue4")
...
abline(coefficients(ID2),lwd = 2,col = "slateblue3")
